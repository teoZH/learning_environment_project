...
urlpatterns = [
    ...
    path('profile/<int:user_id>/company/<int:profile_id>/check-profile', views.see_other_profile, name="check_profile"),
    ...
    path('profile/<int:user_id>/companies/<int:company_id>/delete/', views.delete_company, name='delete_company'),
    path('profile/<int:user_id>/company/<int:company_id>/employee/<int:employee_id>/remove/',
         views.remove_user, name='remove_employee'),
    path('profile/<int:user_id>/companies/hired/',views.show_hired_by,name='show_hired'),
    path('profile/<int:user_id>/companies/hired/<int:company_id>/leave/',views.leave_company,name='leave')
